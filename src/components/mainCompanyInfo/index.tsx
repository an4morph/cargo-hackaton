...
export const MainCompanyInfo = ({ rating }: IProps): JSX.Element => {
  return (
    <div className="flex-col w-1/2 items-center bg-white p-10 rounded-xl">
      ...
      <div className="[&>p]:mb-4 text-1xl flex-col gap-x-10">
        ...
        <h4 className="text-xl font-bold my-4">Raiting:<span className="font-normal"> {rating} <span className="font-bold">/</span> 10</span></h4>
      </div>
    </div>
  )
}
