...
export default function ProfileCompanyPage({ params: { id } }: IProps): JSX.Element | null {
    ...
    <div className="responsive py-10">
      <div className="flex justify-between">
        ...
        <div className="flex gap-x-10">
          <h1 className="text-3xl font-bold bg-black text-white p-4 rounded-lg h-16">{data.company_name}</h1>
      ...
      <div className="flex my-10 justify-evenly gap-x-5">
        <MainCompanyInfo rating={data.rating} />
        {/* <AboutCompanyInfo data={data} /> */}
        {/* <ContactInfo /> */}
      </div>
      <div />
      <InfoModal title="" isOpen={isOpen} onClose={() => setIsOpen(false)}>
        {/* <TruckCharacteristic data={data.about} /> */}
        {/* <TruckCharacteristic /> */}
      </InfoModal>
    </div>
  )
