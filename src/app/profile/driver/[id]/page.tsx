...
export default async function ProfileDriverPage({ params: { id } }: IProps): Promise<JSX.Element> {
  return (
    <div className="responsive py-10">
      <h1 className="text-3xl">(driver) Duglas Cameron</h1>
      <p>{id}</p>
      ...
      <div className="flex">
        <Image
          ...
          alt="driver avatar"
          src="https://images.unsplash.com/photo-1473655587843-eda8944061e8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2072&q=80"
        />
